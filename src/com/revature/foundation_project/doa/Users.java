...
//		preparedStatement.setString(3, adminMobile);
	...
	public void addReceptionist() throws SQLException {
		// TODO Auto-generated method stub
		String currentDateTime = format.format(date);
		System.out.println("Enter new receptionist's id : ");
		String adminid=sc.next();
		...
		preparedStatement.setString(3, receptionistName);
		preparedStatement.setString(4, receptionistPassword);
		preparedStatement.setString(5, receptionistMobile);
		preparedStatement.setString(6, currentDateTime);
		preparedStatement.executeUpdate();
		System.out.println("Great! Welcome aboard.");
	...
	public void addGuest() throws SQLException {
		...
		preparedStatement.setString(5, userMobile);
		preparedStatement.setString(6, currentDateTime);
		preparedStatement.executeUpdate();
		System.out.println("Great! Welcome aboard.");
...
//		preparedStatement.setString(3, receptionistMobile);
		preparedStatement.setString(3, receptionistId);
		preparedStatement.executeUpdate();
